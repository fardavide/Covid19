...
fun initVersions() {
    ...
    // Kotlin
    `kotlin version` =                      "1.3.61"        // Updated: Mar 03, 2020 // TODO 1.3.70 is not compatible with Ktor 1.3.1
    `coroutines version` =                  "1.3.4"         // Updated: Mar 06, 2020
    `serialization version` =               "0.14.0"        // Updated: Mar 04, 2020 // TODO 0.20.0 is not compatible with Ktor 1.3.1
